...
if __name__ == '__main__':
    ...
    grid(int_maps[::-1][:4], ctitles=r'$\phi$', annos=['Entrance Pupil', 'After CPA', 'After AO', 'After NCPA'])
    grid(int_maps[::-1][4:], nrows =2, width=1, ctitles=r'$I$', annos=['Before Coron.', 'After Coron.'], logAmp=True)
    plt.show(block=True)
...
if __name__ == '__main__':
    ...
    for m, ax in enumerate(axes):
        ...
        cb.ax.set_title(ctitles[m], fontsize=16)
        ax.axis('off')
