; $Id: wfa_info.pro,v 7.0 2016/05/19 marcel.carbillet $
;+
; NAME:
;       wfa_info
;
; PURPOSE:
;       wfa_info is the routine that returns the basic informations about
;       the module WFA(see wfa.pro's header --or file caos_help.html-- for details
...
mod_name = 'wfa'
descr    = 'WaveFront Adding'
def_file = mk_par_name(mod_name, PACK_NAME=pack_name, /DEFAULT)

inp_type = 'wfp_t,wfp_t'                     ; Inputs are of type wfp_t
