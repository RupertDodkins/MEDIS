...
def prop_table():
    ...
    for i in range(action_num):
        if len(lens_fl_list) != 0:
            line = "   LENS  " + surface_name_list[i] + "" +  distance_list[i] + "" + sampling_list[i] + "" + beam_diam_list[i] + "" + proper.n * sampling_list[i] + "" + lens_fl_list[i] + "" + lens_eff_fratio_list[i]
        else:
            line = "   SURFACE  " + surface_name_list[i] + "" +  distance_list[i] + "" + sampling_list[i] + "" + beam_diam_list[i] + "" + proper.n * sampling_list[i]
